...
export default function PersonExpensesPage() {
  ...
  return (
    <div className="min-h-screen bg-stone-100">
      <div className="container mx-auto py-6 mt-13 max-w-4xl">
        <div className="mb-6">
          <Button
            variant="outline"
            size="sm"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
            ...
            <div className="flex gap-2">
              <Button className="hover:text-green-700 hover:bg-green-200"  asChild variant="outline ">
        ...
        {/* Balance card */}
        <Card className="mb-6 bg-stone-100 hover:bg-white">
