      ...
      <CardContent>
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-muted rounded-lg p-4">
            <p className="text-lg text-muted-foreground">Total this month</p>
...
{monthlySpending?.[currentMonth]?.total.toFixed(2) || "0.00"}
          ...
          <div className="bg-muted rounded-lg p-4">
            <p className="text-lg text-muted-foreground">Total this year</p>
            <h3 className="text-4xl font-bold mt-1">
              ₹
        ...
        <div className="h-64 mt-6">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={chartData}>
              ...
              />
              <Bar dataKey="amount" fill="#3653d4ff" radius={[4, 4, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
